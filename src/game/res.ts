...
export var RES = {
    MALE_MELEE: 'public/media/rogue-like-8x8/Male-Melee.json',
    FEMALE_MELEE: 'public/media/rogue-like-8x8/Girl-Melee.json',
    NPC_TILESET: 'public/media/rogue-like-8x8/NPC.json',
    MAPTILES: 'public/media/rogue-like-8x8/Tileset2.json',
    ENEMIES: 'public/media/rogue-like-8x8/Enemies.json',
    WEAPONS: 'public/media/rogue-like-8x8/Weapons.json',
    GROUND_ITEMS: 'public/media/rogue-like-8x8/GroundItems.json',
    UI: 'public/media/rogue-like-8x8/UI.json',
    // DRAGON: 'public/media/rogue-like-8x8/Dragon.json',
    MAP_OBJS: 'public/media/rogue-like-8x8/MapObjects.json',

    GAME_MUSIC: 'public/media/music/A Journey Awaits2-lowfi.ogg',
    ATTACK_SWORD_SND: 'public/media/effects/attack_sword2.wav',
    HIT_SND: 'public/media/effects/hit.wav',
    SNAKE_HURT_SND: 'public/media/effects/snake_hurt.wav',
    DEAD_SND: 'public/media/effects/dead.wav',
    SPLASH_SND: 'public/media/effects/splash.wav',
    ARROW_DING_SND: 'public/media/effects/arrow_ding.wav',
    GO_SND: 'public/media/effects/go.wav',
    COIN_SND: 'public/media/effects/coin.wav',
    GATE_SND: 'public/media/effects/gate.wav',
    DROP_SND: 'public/media/effects/drop.wav',
    POWERUP1_SND: 'public/media/effects/powerup1.wav',
    POWERUP2_SND: 'public/media/effects/powerup2.wav',
    POWERUP3_SND: 'public/media/effects/powerup3.wav',
    POWERUP4_SND: 'public/media/effects/powerup4.wav',
    CHEST_SND: 'public/media/effects/chest_open.wav',

    CHUNKS: 'public/map.chunks.json',
    TILESET: 'public/map.tileset.json',
};
