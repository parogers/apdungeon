...
export function Arena(level, width, endx)
{
    this.level = level;
    this.startx = 0;
    this.endx = 0;
...
// the next round)
export function Round(level, delay)
{
    this.level = level;
    this.delay = delay || 0;
...
export function Spawn(level, monster, direction, ypos)
{
    this.level = level;
...
export function GateSpawn(level, monster, gate)
{
    this.level = level;
    this.monster = monster;
    this.gate = gate;
...
// way down, etc.)
export function DropSpawn(level, monster, x, y)
{
    this.level = level;
    this.monster = monster;
    this.xpos = x;
...
export function WaterSpawn(level, monster, x, y)
{
    this.level = level;
    this.monster = monster;
    this.xpos = x;
